...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    RaffleState private s_ruffleState;
    ...
    constructor(
        ...
        s_ruffleState = RaffleState.OPEN;
    ...
    function enterRaffle() public payable {
        ...
        if (s_ruffleState != RaffleState.OPEN) {
    ...
    function checkUpkeep(bytes memory) public override
        ...
        bool isOpen = s_ruffleState == RaffleState.OPEN;
    ...
    function performUpkeep(bytes calldata) public override {
        ...
        if (!upkeepNeeded) {
            revert Raffle_UpkeepNotNeeded(address(this).balance, s_players.length, uint256(s_ruffleState));
        }
        s_ruffleState = RaffleState.CALCULATING;
    ...
    function fulfillRandomWords(uint256, uint256[] memory randowWords) internal override {
